package com.example.mac.moviemanager.adapters;
...
import com.example.mac.moviemanager.activities.MovieDetailActivity;
...
public class MovieRecyclerViewAdapter extends RecyclerView.Adapter<MovieRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvMovieTitle.setText(curMovie.getTitle());
        holder.tvOverview.setText(curMovie.getOverview());
        Picasso.with(getContext())
                .load(curMovie.getPosterPath())
